...
blueprints = [
    ...
    {'module': 'back.src.get.alchemy_get_usuario', 'name': 'alchemy_get_usuarios_bp', 'url_prefix': '/get'},
    ...
    {'module': 'back.src.usuario.t_borrar_usuario', 'name': 'borrar_usuario_bp', 'url_prefix': '/usuario'},
    {'module': 'back.src.usuario.x_delete', 'name': 'xborrar_usuario_bp', 'url_prefix': '/usuario'},
